...
Report completion only after both the matching normalized terminal event and the mapped supervisor process exit have been observed, and the canonical terminal receipt acknowledgement plus private-ledger reconciliation have succeeded. A returned poll, a quiet event stream, or a serviced conversation reply replaces none of them.
